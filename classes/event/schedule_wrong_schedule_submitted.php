...
/**
 * The mod_personalschedule wrong schedule submitted event.
 *
...
class schedule_wrong_schedule_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventschedulewrongsubmitschedulefree', 'mod_personalschedule');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, "personalschedule", "submit", "view.php?id=" .
            $this->contextinstanceid, $this->other['personalscheduleid'],
