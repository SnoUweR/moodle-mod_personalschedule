...
/**
 * The mod_personalschedule report viewed event.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_personalschedule');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the report for the personalschedule with course module id '
    ...
    public function get_url() {
        ...
        return new \moodle_url("/mod/personalschedule/report.php", $params);
    }
